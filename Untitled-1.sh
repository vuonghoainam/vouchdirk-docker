...
mkdir /data/wallets/${DIRK_INSTANCE}

/app/ethdo --base-dir=/data/wallets/${DIRK_INSTANCE}/wallets wallet create \
         --type=distributed --wallet=${WALLET_NAME}

/app/ethdo --base-dir=/data/wallets/${DIRK_INSTANCE}/wallets account create \
